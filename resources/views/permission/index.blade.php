        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right">
                    <a href="{{route('permissions.create')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                            ...
                            <td class="text-center">
                                <div class="form-inline d-inline-flex">
                                    ...
                                    <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm" title="hapus" @cannot('delete permissions') disabled="disabled" @endcannot><i class="fa fa-trash"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
